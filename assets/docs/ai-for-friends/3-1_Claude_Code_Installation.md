...
**What success looks like:** by the end, you'll have Claude Code running in your own terminal, and you'll have had it do one real, saved piece of work for you — without copying or pasting anything.
...
<!-- EXPAND: Before / After — by role (Marketing, HR, Legal, Industrial Engineering, International Relations) -->
...
### 1.2 When the Web Version Is Actually Better
...
> **Honest framing:** Web for thinking. Claude Code for producing. Most people use both. The whole price of Claude Code is a ~30-minute learning curve, being on a computer rather than a phone, and typing a few commands.

---

## Section 2: Installation

> 💬 **In Plain English:** You're installing two free programs (VS Code and Claude Code) and connecting them to your paid Claude Pro account. Every step below has a "checkpoint" so you know you're on track — and this section ends with Claude Code actually running.
...
> 🎉 **It's Running.** That's Claude Code, live, in your terminal, for the first time. Everything from here is just pointing it at real work.
...
> 💬 **In Plain English:** For everything in this guide, use the VS Code Integrated Terminal — open it with Ctrl + ` (the backtick key, top-left of your keyboard). You never need to open a separate terminal program. You only need six commands, and you already used the most important one — `claude` — in the last section.

### 3.1 Other Terminals (Optional Background — Skip If You're in a Hurry)

| Terminal | What it is | When you'll use it |
|---|---|---|
| Windows PowerShell | Modern Windows default shell | Installation (Section 2) only |
...
### 4.3 Working With Word, PDF, and Excel Files
...
### 4.4 Exercise 1 — Ask a Question (Read-Only, Zero Risk)
...
### 4.5 Exercise 2 — Have Claude Create a File
...
> 🎉 **That's a Real, Saved File.** Claude read your documents and wrote something new to disk — no copy-paste. That's the whole unlock this course has been building toward.

<!-- EXPAND: Want to go further? Two more exercises -->
...
### 5.1 CLAUDE.md — Teach Claude Your Standards Once
...
### 5.5 Safety, Confidentiality, and Good Habits
